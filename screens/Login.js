  ...
  return (
    <View style={styles.container}>
      ...
      <SafeAreaView style={styles.form}>
        <Text style={styles.title}>Heart Fix</Text>
         <TextInput
        style={styles.input}
      ...
      <View style={{marginTop: 20, flexDirection: 'row', alignItems: 'center', alignSelf: 'center'}}>
        <Text style={{color: 'gray', fontWeight: '600', fontSize: 14}}>Não tem conta? </Text>
        <TouchableOpacity onPress={() => navigation.navigate("Signup")}>
          <Text style={{color: "#ec5252", fontWeight: '600', fontSize: 14}}>Cadastre-se</Text>
        </TouchableOpacity>
      </View>
      </SafeAreaView>
